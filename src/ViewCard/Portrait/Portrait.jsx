          ...
          <div className="padding-whole-10-l-a">
            ...
            <div className="top-profile-container-left-align">
              <div className="portrait-profile-pic-box">
                <img src={ppic} alt="" className="portrait-pp" />
              </div>
              ...
              <div className="info-user-left-card-padding-portrait">
              ...
              <div className="bottom-inner-content-left-a">
              ...
              <div className="profile-pic-container-left-align">
                <div className="profile-pic-c-l-a">
                  <img src={pla} alt="" />
                </div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="clickable-link-section">
                <div className="sections-title">Clickable Links</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="multimedia-section">
                <div className="sections-title p-10-side-l-a">Multimedia</div>
                {videos.length === 1 ? (
                ...
                <div className="youtube-video-title">YouTube Video</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="contact-form-left-align">
                <div className="sections-title">Contact Form</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="about-section">
                <div className="sections-title">About</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="document-section-box-l-a">
                <div className="sections-title">Document</div>
                {pdf.length > 1 ? (
                  <Slider {...sliderSettings}>
                    {pdf.map((pdf, index) => (
            ...
            <div className="grey-box-bg-left-align">
              <div className="team-member-details-box-l-a">
                <div className="sections-title">Team Member Details </div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="address-section-box-l-a">
                <div className="sections-title">Address</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="social-proof-section-l-a">
                <div className="sections-title">Social Proof</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="photos-section-l-a">
                <div className="sections-title">Photos</div>
            ...
            <div className="grey-box-bg-left-align">
              <div className="product-gallery-box-l-a">
                <div className="sections-title">Product gallery</div>
