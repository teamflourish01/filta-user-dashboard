      ...
      <div className={`hamburger-container ${isMenuOpen ? "open" : ""}`}>
        ...
        <div className="profile-section-ham">
          ...
          {isProfileMenuOpen && (
            <div className="profile-dropdown-menu">
              <ul>
                <Link className="sb-link" to="/request-feature" onClick={closeHamburgerMenu}>
                  <li>Request a feature</li>
                </Link>
                <Link className="sb-link" to="/logout" onClick={handleLogOut}>
                  <li>Logout</li>
                </Link>
              </ul>
            </div>
        ...
        <div className="menu-ham">
          ...
          <Link
            ...
            className={`menu-item-ham ${
              location.pathname.startsWith("/virtual-background")
                ? "active"
                : ""
            }`}
            onClick={closeHamburgerMenu}
